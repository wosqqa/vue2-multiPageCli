...
<div class="qr-face">
	...
	<div  class="box-c" v-if="noluck">
		<div class="box-ca" >
			...
			<div class="box-cac" ><img src="../../assets/lottery/qqno.png" alt=""></div>
...
<script>
import {jsonpGetData,qqLuckyRoller,qqLuckyRunner,getQqUserDraws,hostname} from '@/scripts/api/api';
	...
	export default {
		...
		methods: {
			qrRecord(){
				...
				window.location.href = '/qr_record.html?loginToken='+this.loginToken+'&type="qq"'
			},
			getUserDraws(){//抽奖次数
				let scope=this;
				let listObj = {
...
.qr-face{
  background-image: url('../../assets/lottery/qqbg.png');
  ...
  .box-b{
	  ...
	  .box-bc{
		  ...
		  .box-bca{
				...
				margin: 0 auto;
				text-align: center;
				background-image: url('../../assets/lottery/zjjl-btn.png');
				background-repeat: no-repeat;
				background-size: cover;
				span{
					background-image: url('../../assets/lottery/icon.png');
					background-repeat: no-repeat;
					background-size: cover;
  ...
  .box-c{
	  .box-ca{
		...
		.box-cae{
			...
			background-image: url('../../assets/lottery/shareqq.png');
			background-repeat: no-repeat;
			background-size: contain;
	  ...
	  .box-cd{
		background-image: url('../../assets/lottery/zjla.png');
		background-repeat: no-repeat;
		background-size: contain;
		background-position: center;
		margin: 23% 1.27rem;
		...
		.box-cabd{
			width: 4.4rem;
			height: 1.6rem;
			background-image: url('../../assets/lottery/zjlbtn.png');
			background-repeat: no-repeat;
			background-size: contain;
			background-position: center;
  ...
  .box-d{
	  ...
	  text-align: center;
	  .box-da{
		background-image: url('../../assets/lottery/bsbtn.png');
		background-repeat: no-repeat;
		background-size: contain;
		background-position: center;
		width: 10rem;
