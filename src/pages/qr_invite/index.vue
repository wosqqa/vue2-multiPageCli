...
.qr-container{
  ...
  height: 16.2rem;
  font-size: 12px;
  background-image: url('../../assets/sewmbs@3.png');
  ...
  .qrinvite-container{
    ...
    .qrinvite-container-footer{
      ...
      margin: 0 15%;
      .box3-img-pyq{
        @include bgnrcbc(1rem,'../../assets/icon/pyq');
      }
      .box3-img-wx{
        @include bgnrcbc(1rem,'../../assets/icon/wx');
      }
      .box3-img-qq{
        @include bgnrcbc(1rem,'../../assets/icon/QQ');
      }
      .box3-img-dx{
        @include bgnrcbc(1rem,'../../assets/icon/dx');
      }
      .box3-img-kj{
        @include bgnrcbc(1rem,'../../assets/icon/QQkj');
      }
    }
  }
}
