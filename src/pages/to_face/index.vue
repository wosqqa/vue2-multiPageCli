...
<div class="qr-face">
	...
	<div  class="box-c" v-show="noluck">
		<div class="box-ca" >
			...
			<div class="box-cad" ><img src="../../assets/lottery/tipbz.png" alt=""></div>
...
<script>
import {jsonpGetData,LuckyRoller,LuckyRunner,getUserDraws,hostname} from '@/scripts/api/api';
...
const lottery = resolve => require(['@/components/invite_lottery.vue'], resolve)
	...
	export default {
		...
		created(){
			var scope = this
			scope.urlParam = GLOBAL.App().getParamsFromUrl(); 
		...
		methods: {
			...
			qrRecord(){
				...
				window.location.href = '/qr_record.html?loginToken='+this.loginToken+'&type="qr"'
			},
			getUserDraws(){//抽奖次数
				let scope=this;
				let listObj = {
...
.qr-face{
  background-image: url('../../assets/lottery/box-bg.png');
  ...
  .box-b{
	  ...
	  .box-bc{
		  ...
		  .box-bca{
				...
				padding-top: 0.05rem;
				span{
					background-image: url('../../assets/lottery/dicon.png');
					background-repeat: no-repeat;
					background-size: cover;
